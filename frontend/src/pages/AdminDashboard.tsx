  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow">
        <div className="max-w-[1480px] mx-auto px-2 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
      ...
      {/* Main Content */}
      <main className="max-w-[1480px] mx-auto px-2 sm:px-6 lg:px-8 py-4">
        {/* Welcome Card */}
